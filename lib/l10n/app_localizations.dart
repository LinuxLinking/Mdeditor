...
/// Library-private localization data (top-level so the delegate can read it
/// without violating Dart's library privacy rules).
...
const Map<String, String> _en = <String, String>{
  ...
  'no_recent_body': 'Create a Markdown document or open one from this device.',
  'home_tagline': 'WYSIWYG Markdown, anywhere.',
  ...
  'toolbar_bullet': 'Bulleted list',
  'toolbar_number': 'Numbered list',
  'toolbar_quote': 'Quote',
  'toolbar_task': 'Task',
  'toolbar_code': 'Code block',
  'toolbar_image': 'Image',
  'toolbar_link': 'Link',
  'export': 'Export',
};
...
class _AppLocalizationsDelegate
  ...
  Future<AppLocalizations> load(Locale locale) async {
    return AppLocalizations(locale.languageCode == 'en' ? _en : _zh);
  }
